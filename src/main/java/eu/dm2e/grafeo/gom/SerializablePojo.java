...
public abstract class SerializablePojo<T> {
	...
	public String toJson() {
		return GrafeoJsonSerializer.serializeToJSON(this, getClass());
	}
	public JsonObject toJsonObject() {
		return GrafeoJsonSerializer.serializeToJsonObject(this, getClass());
	}
	public Entity toJsonEntity() {
		return Entity.entity(
			GrafeoJsonSerializer.serializeToJSON(this, getClass()),
...
//    public T copy() {
//
//    	SerializablePojo<T> that = GrafeoJsonSerializer.deserializeFromJSON(this.toJson(), this.getClass());
//
//		return (T) that;
//    }
